                         ...
                         const bool is_causal)
{
    ...
    /*
    DPCT1005:0: The SYCL device version is different from CUDA Compute Compatibility. You may need
    to rewrite this code.
    */
    /* bool is_sm8x = dprops->get_major_version() == 8 && dprops->get_minor_version() >= 0; */
    /*
    DPCT1005:1: The SYCL device version is different from CUDA Compute Compatibility. You may need
    to rewrite this code.
    */
    /* bool is_sm90 = dprops->get_major_version() == 9 && dprops->get_minor_version() == 0; */
