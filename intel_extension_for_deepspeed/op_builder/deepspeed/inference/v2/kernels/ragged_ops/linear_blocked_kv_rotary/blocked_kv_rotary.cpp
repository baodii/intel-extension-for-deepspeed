                                  ...
                                  torch::Tensor& kv_ptrs)
{
    ...
    DISPATCH_KV_ROTARY(kHalf, sycl::half);

#ifdef BF16_AVAILABLE
    DISPATCH_KV_ROTARY(kBFloat16, sycl::ext::oneapi::bfloat16);
#endif
}
                    ...
                    torch::Tensor& kv_ptrs)
{
    ...
    DISPATCH_KV_COPY(kHalf, sycl::half);

#ifdef BF16_AVAILABLE
    DISPATCH_KV_COPY(kBFloat16, sycl::ext::oneapi::bfloat16);
#endif
}
