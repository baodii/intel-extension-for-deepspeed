...
template <int AccessSize>
__dpct_inline__ void memcpy_async(void* shr, const void* gbl);

template <int AccessSize>
__dpct_inline__ void memcpy_async_nop(void* shr, const void* gbl, bool predicate);

template <int AccessSize>
__dpct_inline__ void memcpy_async_zero(void* shr, const void* gbl, bool predicate);

__dpct_inline__ void memcpy_async_fence();

template <int stages>
__dpct_inline__ void memcpy_async_wait();

template <int stages>
__dpct_inline__ void tail_complete_wait(int remaining_stages);
#endif
...
template <int AccessSize>
__dpct_inline__ void memcpy_async_zero_nop(void* shr,
                                           const void* gbl,
                                           bool zero_predicate,
                                           bool nop_predicate)
{
...
__dpct_inline__ void memcpy_async_cg(void* shr, const void* gbl)
{
    unsigned shr_int = internal::convert_to_shared(shr);
...
__dpct_inline__ void memcpy_async_nop_cg(void* shr, const void* gbl, bool predicate)
{
    unsigned shr_int = internal::convert_to_shared(shr);
...
__dpct_inline__ void memcpy_async_zero_cg(void* shr, const void* gbl, bool predicate)
{
    unsigned shr_int = internal::convert_to_shared(shr);
...
__dpct_inline__ void memcpy_async_zero_nop_cg(void* shr,
                                              const void* gbl,
                                              bool zero_predicate,
                                              bool nop_predicate)
{
...
*/
__dpct_inline__ void memcpy_async_fence() { asm volatile("cp.async.commit_group;\n"); }
...
template <>
__dpct_inline__ void tail_complete_wait<1>(int remaining_stages)
{
    if (remaining_stages == 0) memcpy_async_wait<0>();
}

template <>
__dpct_inline__ void tail_complete_wait<2>(int remaining_stages)
{
...
template <>
__dpct_inline__ void tail_complete_wait<3>(int remaining_stages)
{
...
template <>
__dpct_inline__ void tail_complete_wait<4>(int remaining_stages)
{
...
template <>
__dpct_inline__ void tail_complete_wait<5>(int remaining_stages)
{
...
template <>
__dpct_inline__ void tail_complete_wait<6>(int remaining_stages)
{
