...
{
    return sycl::vec<unsigned, 1>(val).convert<sycl::half, sycl::rounding_mode::rte>()[0];
}
template <>
...
{
    return sycl::float2(val).convert<sycl::half, sycl::rounding_mode::rte>();
}
...
{
    /*
    DPCT1007:11: Migration of __ll2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:12: Migration of __int2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:13: Migration of __short2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:14: Migration of __int2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:15: Migration of __ull2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:16: Migration of __uint2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:17: Migration of __ushort2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
template <>
...
{
    /*
    DPCT1007:18: Migration of __uint2bfloat16_rn is not supported.
    */
    return sycl::ext::oneapi::bfloat16(val);
}
#endif
...
{
    return sycl::vec<sycl::half, 1>(val).convert<unsigned, sycl::rounding_mode::rte>()[0];
}
// No direct support for integer casts at the C++ level and I don't feel they're so important
// to demand an PTX at this time
